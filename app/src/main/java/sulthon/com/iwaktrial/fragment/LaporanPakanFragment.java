...
/*kelas ini adalah kelas fragment lanjutan setelah menekan tombol simpan jumlah pakan
pada fragment laporan harian
 */

public class LaporanPakanFragment extends Fragment {

    private View view;
    private TextView tvLabel;
    private Button btnKembali;

    public LaporanPakanFragment() {
    }

    public static LaporanPakanFragment newInstance(){
        LaporanPakanFragment fragment = new LaporanPakanFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_laporan_pakan,container,false);
